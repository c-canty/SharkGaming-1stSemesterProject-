...
namespace SharkGaming.Pages.ProductInfoPages.ComponentInfoPages
{
    public class GpuPage3Model : PageModel
    {
        ...
        public GpuPage3Model(IProductService productService, IOrderRepositoryService orderService)
        {
        ...
        {
            _orderService.AddToCart(17, 1, 3881.03);
            return RedirectToPage("GpuPage3");
        }
    }
}
