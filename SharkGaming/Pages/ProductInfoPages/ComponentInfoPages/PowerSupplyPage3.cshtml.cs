...
namespace SharkGaming.Pages.ProductInfoPages.ComponentInfoPages
{
    public class PowerSupplyPage3Model : PageModel
    {
        ...
        public PowerSupplyPage3Model(IProductService productService, IOrderRepositoryService orderService)
        {
        ...
        {
            _orderService.AddToCart(23, 1, 1130.61);
            return RedirectToPage("PowerSupplyPage3");
        }
    }
}
